...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sinfo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10511&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sinfo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sinfo` can be installed with:

```
conda install sinfo
```

It is possible to list all of the versions of `sinfo` available on your platform with:
